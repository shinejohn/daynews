...
import { ChevronLeft, Calendar, MapPin, Copy, Scissors, Share2, Bookmark, ExternalLink, AlertCircle, Check, Mail, Phone, Globe, Tag, Clock, Info } from 'lucide-react';
  ...
  return <div className="flex-1 overflow-auto bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-6">
          <button onClick={() => navigate('/')} className="hover:text-news-primary">
            Home
          </button>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="flex space-x-3">
                <button onClick={() => alert('Shared on Facebook')} className="bg-[#1877F2] text-white p-2 rounded-full hover:bg-opacity-90">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </button>
                <button onClick={() => alert('Shared on Twitter')} className="bg-[#1DA1F2] text-white p-2 rounded-full hover:bg-opacity-90">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              }} className="bg-gray-800 text-white p-2 rounded-full hover:bg-opacity-90">
                  <Mail className="h-5 w-5" />
                </button>
                <button onClick={() => {
                navigator.clipboard.writeText(window.location.href);
                alert('Link copied to clipboard!');
              }} className="bg-news-primary text-white p-2 rounded-full hover:bg-opacity-90">
                  <Share2 className="h-5 w-5" />
                </button>
              </div>
              <div className="mt-4">
        ...
        <div className="mt-8 text-center">
          <button onClick={() => alert('Thank you for reporting this coupon. Our team will review it.')} className="flex items-center justify-center mx-auto text-gray-500 hover:text-gray-700">
