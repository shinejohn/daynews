          ...
          <div className="px-6 pb-6">
            <div className="flex flex-col md:flex-row md:items-end -mt-16 mb-4">
              ...
              <div className="mt-4 md:mt-0 md:ml-auto">
                <button onClick={() => navigate('/settings')} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-md font-medium hover:bg-gray-200 transition-colors flex items-center">
        ...
        {userActivity.articles.length === 0 && <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-lg shadow-md mb-6 overflow-hidden">
            <div className="px-6 py-6 text-white flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex space-x-3">
                <button onClick={() => navigate('/author/profile-creator')} className="px-4 py-2 bg-white text-blue-700 rounded-md font-medium hover:bg-blue-50 transition-colors flex items-center">
                  <Pen className="h-4 w-4 mr-1.5" />
                  Create Author Profile
                </button>
                <button onClick={() => navigate('/create-article')} className="px-4 py-2 bg-blue-500 text-white rounded-md font-medium hover:bg-blue-400 border border-blue-400 transition-colors flex items-center">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          {activeTab === 'profile' && <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-news-primary hover:shadow-sm transition-all">
                  ...
                  <button onClick={() => navigate('/create-article')} className="px-4 py-2 bg-news-primary text-white rounded-md font-medium hover:bg-news-primary-dark transition-colors text-sm">
                    Start Writing
                  </button>
                </div>
                <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-news-primary hover:shadow-sm transition-all">
                  ...
                  <button onClick={() => navigate('/announcementCreator')} className="px-4 py-2 bg-news-primary text-white rounded-md font-medium hover:bg-news-primary-dark transition-colors text-sm">
                    Create Announcement
                  </button>
                </div>
                <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-news-primary hover:shadow-sm transition-all">
                  ...
                  <button onClick={() => navigate('/postListing')} className="px-4 py-2 bg-news-primary text-white rounded-md font-medium hover:bg-news-primary-dark transition-colors text-sm">
                    Create Listing
                  </button>
                </div>
                <div className="border border-gray-200 rounded-lg p-6 text-center hover:border-news-primary hover:shadow-sm transition-all">
          ...
          {activeTab === 'saved' && <div>
              ...
              {userActivity.savedArticles.length > 0 ? <div className="space-y-4">
                  ...
                  <button onClick={() => navigate('/')} className="px-4 py-2 bg-news-primary text-white rounded-md font-medium hover:bg-news-primary-dark transition-colors">
                    Browse Articles
                  </button>
                </div>}
            </div>}
          ...
          {activeTab === 'announcements' && <div>
              ...
              {userActivity.announcements.length > 0 ? <div className="space-y-4">
                  ...
                  <button onClick={() => navigate('/announcementCreator')} className="px-4 py-2 bg-news-primary text-white rounded-md font-medium hover:bg-news-primary-dark transition-colors">
                    Create Announcement
                  </button>
                </div>}
            </div>}
          ...
          {activeTab === 'events' && <div>
              ...
              {userActivity.events.length > 0 ? <div className="space-y-4">
                  ...
                  <button onClick={() => navigate('/eventCreator')} className="px-4 py-2 bg-news-primary text-white rounded-md font-medium hover:bg-news-primary-dark transition-colors">
                    Create Event
                  </button>
                </div>}
            </div>}
