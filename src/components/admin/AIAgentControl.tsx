...
const systemResources = {
  cpu: [25, 28, 32, 45, 40, 35, 38, 42, 48, 50, 47, 52, 55, 58, 62, 60, 65, 68, 72, 70, 75, 78, 82, 80],
  memory: [35, 38, 42, 45, 48, 52, 55, 58, 60, 62, 65, 68, 70, 72, 75, 78, 80, 82, 85, 88, 86, 90, 92, 90],
  apiCalls: {
    total: 15842,
    perMinute: 42,
    distribution: {
