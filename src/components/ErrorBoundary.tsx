    ...
    if (this.state.hasError) {
      return<div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 text-center mb-4">We're having trouble loading this page. Please try refreshing or
            ...
            <div className="text-center">
              <button onClick={() =>window.location.reload()} className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
                Refresh Page</button>
            </div>{this.state.error && process.env.NODE_ENV === 'development' &&<div className="mt-4 p-3 bg-gray-100 rounded-md">
