...
import { ThumbsUp, Heart, AlertCircle, MessageSquare, Share2, Bookmark } from 'lucide-react';
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-30">
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center space-x-4">
            <button className="flex flex-col items-center" onClick={() => handleReaction('helpful')}>
              <ThumbsUp className="h-5 w-5 text-gray-600" />
              <span className="text-xs text-gray-600">{reactions.helpful}</span>
            </button>
            <button className="flex flex-col items-center" onClick={() => handleReaction('love')}>
              <Heart className="h-5 w-5 text-gray-600" />
              <span className="text-xs text-gray-600">{reactions.love}</span>
            </button>
            <button className="flex flex-col items-center" onClick={() => handleReaction('surprising')}>
