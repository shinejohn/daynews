'use client';
// Data wrapper for LegalNoticesPreview
// This wrapper integrates Supabase data while preserving the Magic Patterns component structure

import React, { useEffect, useState } from 'react';
import { LegalNoticesPreview as OriginalLegalNoticesPreview } from './LegalNoticesPreview.original';
...
export const LegalNoticesPreview = () => {
  ...
  return <OriginalLegalNoticesPreview />;
};
