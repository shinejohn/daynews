...
import { Briefcase, ChevronRight, ExternalLink, Home, MapPin, ShoppingBag, Tag, Wrench } from 'lucide-react';
  ...
  return <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
      ...
      <div className="lg:col-span-3 order-1 lg:order-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {featuredListings.map(listing => <div key={listing.id} className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden flex flex-col cursor-pointer hover:shadow-md transition-all" onClick={() =>onAdClick && onAdClick('classifiedDetail')}><div className="relative h-48">
